...
for position in range(genome_length):
	...
	if(current_coverage > 0):
		print(current_sum/current_coverage) # divide the fragment length for phycoverage => length of fragments of a certain base area X / fragments number of a certain base area X
	else:
 	# region reference genome unmapped
		print(-1)
